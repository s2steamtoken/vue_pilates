    ...
    app: {
        head: {
            ...
            link: [
                ...
                { rel: 'stylesheet', type: 'text/css', href: '/lib/bootstrap/css/bootstrap.css?8' },
                { rel: 'stylesheet', type: 'text/css', href: '/css/font.css?8' },
                { rel: 'stylesheet', type: 'text/css', href: '/css/main.css?21' },
                { rel: 'stylesheet', type: 'text/css', href: '/css/main1440.css?19' },
                { rel: 'stylesheet', type: 'text/css', href: '/css/main1024.css?19' },
                { rel: 'stylesheet', type: 'text/css', href: '/css/main768.css?19' },
                { rel: 'stylesheet', type: 'text/css', href: '/css/main500.css?18', },
